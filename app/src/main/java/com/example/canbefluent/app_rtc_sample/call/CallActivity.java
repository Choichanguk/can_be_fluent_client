...
import com.example.canbefluent.app_rtc_sample.web_rtc.AppRTCAudioManager;
import com.example.canbefluent.app_rtc_sample.web_rtc.AppRTCClient;
import com.example.canbefluent.app_rtc_sample.web_rtc.AppRTCClient.RoomConnectionParameters;
import com.example.canbefluent.app_rtc_sample.web_rtc.AppRTCClient.SignalingParameters;
import com.example.canbefluent.app_rtc_sample.web_rtc.PeerConnectionClient;
import com.example.canbefluent.app_rtc_sample.web_rtc.PeerConnectionClient.PeerConnectionParameters;
import com.example.canbefluent.app_rtc_sample.web_rtc.WebSocketRTCClient;
//import com.myhexaville.androidwebrtc.databinding.ActivityCallBinding;

import com.example.canbefluent.app_rtc_sample.web_rtc.AppRTCAudioManager;
import com.example.canbefluent.app_rtc_sample.web_rtc.AppRTCClient;
import com.example.canbefluent.app_rtc_sample.web_rtc.PeerConnectionClient;
import com.example.canbefluent.databinding.ActivityCallBinding;
...
import static com.example.canbefluent.app_rtc_sample.util.Constants.CAPTURE_PERMISSION_REQUEST_CODE;
import static com.example.canbefluent.app_rtc_sample.util.Constants.EXTRA_ROOMID;
import static com.example.canbefluent.app_rtc_sample.util.Constants.LOCAL_HEIGHT_CONNECTED;
import static com.example.canbefluent.app_rtc_sample.util.Constants.LOCAL_HEIGHT_CONNECTING;
import static com.example.canbefluent.app_rtc_sample.util.Constants.LOCAL_WIDTH_CONNECTED;
import static com.example.canbefluent.app_rtc_sample.util.Constants.LOCAL_WIDTH_CONNECTING;
import static com.example.canbefluent.app_rtc_sample.util.Constants.LOCAL_X_CONNECTED;
import static com.example.canbefluent.app_rtc_sample.util.Constants.LOCAL_X_CONNECTING;
import static com.example.canbefluent.app_rtc_sample.util.Constants.LOCAL_Y_CONNECTED;
import static com.example.canbefluent.app_rtc_sample.util.Constants.LOCAL_Y_CONNECTING;
import static com.example.canbefluent.app_rtc_sample.util.Constants.REMOTE_HEIGHT;
import static com.example.canbefluent.app_rtc_sample.util.Constants.REMOTE_WIDTH;
import static com.example.canbefluent.app_rtc_sample.util.Constants.REMOTE_X;
import static com.example.canbefluent.app_rtc_sample.util.Constants.REMOTE_Y;
import static com.example.canbefluent.app_rtc_sample.util.Constants.STAT_CALLBACK_PERIOD;
...
//            processAndRecognize(bitmap);
        ...
        Log.e(LOG_TAG, "peerConnectionParameters 생성");

        // Create connection client. Use DirectRTCClient if room name is an IP otherwise use the
        // standard WebSocketRTCClient.
        appRtcClient = new WebSocketRTCClient(this);
        Log.e(LOG_TAG, "appRtcClient 생성");
        // Create connection parameters.
        roomConnectionParameters = new RoomConnectionParameters("https://appr.tc", roomId, false);
        Log.e(LOG_TAG, "roomConnectionParameters 생성");
        setupListeners();

        peerConnectionClient = PeerConnectionClient.getInstance();

        peerConnectionClient.createPeerConnectionFactory(this, peerConnectionParameters, this);
        Log.e(LOG_TAG, "peerConnectionClient 생성");

//        startCall();
    }

    private void setupListeners() {
        Log.e(LOG_TAG, "setupListeners");
